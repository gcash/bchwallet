// Copyright (c) 2013-2016 The gcash developers
...
func (c *RPCClient) onRecvTx(tx *bchutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *bchutil.Tx, block *btcjson.BlockDetails) {
